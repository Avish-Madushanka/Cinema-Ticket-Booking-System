...
<section class="bg-white dark:bg-gray-900 mt-8">
    <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16">
        ...
        <p class="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 lg:px-48 dark:text-gray-400">Cinema hall bookings are now convienient, fast and at your finger tips! Book your fav movie now with no hassles!</p>
